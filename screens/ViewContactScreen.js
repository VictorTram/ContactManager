...
export default class ViewContactScreen extends React.Component{
    ...
    componentDidMount(){
        ...
        navigation.addListener("willFocus", () => {
            // .getParams(Key, <Key's default val>)
    ...
    getContact = async key => {
        ...
        .then(contactJsonString => {
            console.log("getContact: " + key);
            var contact = JSON.parse(contactJsonString);
            contact["key"] = key;
            //same as this.setState(contact: contact);
            console.log("Before Test: " + this.state.fname);
            this.setState(contact);
            console.log("After Test: " + this.state.fname);
            console.log("After update: " + this.state.key);
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <Card>
                    ...
                    <CardItem bordered>
                        <Text style= {styles.infoText}>{this.state.key}</Text>
                    </CardItem>
                </Card>
                <Card>
                    <CardItem bordered>
